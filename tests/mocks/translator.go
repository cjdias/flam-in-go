...
func (m *MockTranslator) FmtAccounting(num float64, v uint64, currency currency.Type) string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FmtAccounting", num, v, currency)
	ret0, _ := ret[0].(string)
	return ret0
}
...
func (mr *MockTranslatorMockRecorder) FmtAccounting(num, v, currency interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FmtAccounting", reflect.TypeOf((*MockTranslator)(nil).FmtAccounting), num, v, currency)
}

// FmtCurrency mocks base method.
func (m *MockTranslator) FmtCurrency(num float64, v uint64, currency currency.Type) string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FmtCurrency", num, v, currency)
	ret0, _ := ret[0].(string)
	return ret0
}
...
func (mr *MockTranslatorMockRecorder) FmtCurrency(num, v, currency interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FmtCurrency", reflect.TypeOf((*MockTranslator)(nil).FmtCurrency), num, v, currency)
}
...
func (mr *MockTranslatorMockRecorder) T(key interface{}, params ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{key}, params...)
